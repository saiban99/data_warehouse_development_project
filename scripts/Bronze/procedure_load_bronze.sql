...
BEGIN
	...
	BEGIN TRY
		...
		FROM 'FROM 'C:\Users\Saiban N Pagarkar\OneDrive\Desktop\DE_projects\Data_Warehouse_and_Analytics_using_SQL\datasets\source_crm\cust_info.csv''
		WITH (
			FIRSTROW = 2,
			FIELDTERMINATOR = ',',
			TABLOCK
		...
		FROM 'FROM 'C:\Users\Saiban N Pagarkar\OneDrive\Desktop\DE_projects\Data_Warehouse_and_Analytics_using_SQL\datasets\source_crm\prd_info.csv''
		WITH (
			FIRSTROW = 2,
			FIELDTERMINATOR = ',',
			TABLOCK
